...
# -*- coding: utf-8 -*-
"""
harp.py: Six-string laser harp with MIDI output
 ...
 * The MIDI note codes for a major scale are: 60,62,64,65,67,69,71,73
...
if __name__ == "__main__":
    ## Define your six strings (low-note strings first)
    lstrings = [None]*6
